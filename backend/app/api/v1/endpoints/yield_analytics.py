...
def get_quality_report(db: Session = Depends(get_db)):
    ...
    return {
        ...
        "manufacturing_intelligence": {
            ...
            "summary": "Overall manufacturing intelligence indicates a {} operation with {} yield.".format(
                "stable" if variation < 5 else "variable",
                "excellent" if overall_yield > 90 else "good" if overall_yield > 80 else "needs improvement"
            )
        },
